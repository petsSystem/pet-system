...
export default function Calendar() {
  ...
  const events = [
    // Previous month
    {
      ...
      eventName: "⛱️ Feriado, dia de relaxar",
      eventColor: "primary",
    },
    {
      eventStart: new Date(
        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-4">
          ...
          <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <button className="btn bg-primary-500 hover:bg-primary-600 text-white">
              ...
              <span className="hidden xs:block ml-2">Criar agendamento</span>
            </button>
          </div>
        </div>
        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-4">
          ...
          <div className="mb-4 sm:mb-0 mr-2">
            <ul className="flex flex-wrap items-center -m-1">
              ...
              <li className="m-1">
                <button className="btn-sm bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-500 dark:text-slate-400">
                  <div className="w-1 h-3.5 bg-primary-500 shrink-0"></div>
              ...
              {/* <li className="m-1">
                <button className="btn-sm bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-primary-500">
                  +Novo agendamento
                </button>
              </li> */}
            </ul>
          ...
          {/* <div className="flex flex-nowrap -space-x-px">
            <button className="btn bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-primary-500 rounded-none first:rounded-l last:rounded-r">
              Mês
            </button>
            <button className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 text-slate-600 dark:text-slate-300 rounded-none first:rounded-l last:rounded-r">
              Semana
            </button>
            <button className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 text-slate-600 dark:text-slate-300 rounded-none first:rounded-l last:rounded-r">
              Dia
