...
const DropdownUser = () => {
  ...
  return (
    <div className="relative bg-boxdark">
      <div
        ref={trigger}
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full overflow-hidden  border border-width-2 rounded-full border-primary-500">
          <Image src="/user.png" alt="Logo" width={100} height={100} />
        </span>
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default border-strokedark dark:bg-boxdark ${
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li>
            <Link
              href="/"
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base pt-2"
            >
              <svg
          ...
          <li>
            <Link
              href="/"
              className="pb-2 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            >
              <svg
                className="fill-current"
                width="22"
        ...
        {/* <button
          ...
          className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary-500 lg:text-base"
        >
          Sair
        </button> */}
      </div>
