...
export function HeaderPS({ title, subTitle }: Props) {
  const { sidebarOpen, setSidebarOpen } = useApp();
  const { companies, selectedCompany, setSelectedCompanyLocally } =
    useCompany();
  ...
  const handleSelect = (data: any) => {
    setSelectedCompanyLocally(data.company);
    route.replace("/admin");
  };

  function convertArray(array: OriginalItem[]): ConvertedItem[] {
